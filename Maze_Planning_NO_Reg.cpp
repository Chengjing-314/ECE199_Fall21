...
int main(){
    ...
    start->as<ob::RealVectorStateSpace::StateType>()->values[1] = 90.0;
    
   
    ob::ScopedState<> goal(space);
    goal->as<ob::RealVectorStateSpace::StateType>()->values[0] = 90.0;
    goal->as<ob::RealVectorStateSpace::StateType>()->values[1] = 22.0;
    ...
    // planning time
    ob::PlannerStatus solved = optimizingPlanner->solve(30);
